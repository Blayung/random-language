...
**This mod currently supports all minecraft versions from 1.19.4 to 1.20.2.**  
...
3. Now the mod jar file should be here: `./build/libs/randomized-language-1.2.9.jar`
